...
class PerformanceCounterAgent:
    ...
    def calculate_efficiency_score(self) -> float:
        ...
        avg_cpu = sum(self.performance_metrics["cpu_usage"]) / len(
            self.performance_metrics["cpu_usage"]
        )
        avg_memory = sum(self.performance_metrics["memory_usage"]) / len(
            self.performance_metrics["memory_usage"]
        )
        avg_time = sum(self.performance_metrics["execution_times"]) / len(
