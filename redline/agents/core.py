...
class CognitiveAgent(BaseAgent):
    ...
    async def process(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Derive findings
        findings = await self.toolkit.use_tool(
            "finding_derivation", {"explanations": explanations, "gaps": gaps}
        )

        return {"explanations": explanations, "gaps": gaps, "findings": findings}
...
class PlanningAgent(BaseAgent):
    ...
    async def process(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"plan": plan, "tool_setup": tool_setup}
...
class ActionAgent(BaseAgent):
    ...
    async def process(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        self.memory.store_reasoning_step(
            Message(role="action_results", content=str(observations))
        )
